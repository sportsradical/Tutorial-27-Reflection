...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/seafloor.tga", "../Engine/data/cube.txt");
	if(!result)
	{
	...
	result = m_FloorModel->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/red_01.tga", "../Engine/data/floor.txt");
	if(!result)
	{
